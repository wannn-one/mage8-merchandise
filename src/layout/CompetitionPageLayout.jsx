  ...
  return (
    <>
      <div className="flex-col mt-28 flex items-center justify-center">
        <h1 className="text-center font-bold  text-xl sm:text-4xl  leading-tight">{'About ' + '' + props.judulCompe + ' Competition'}</h1>
      ...
      <div className="flex items-center justify-center">
        ...
        <a className="mt-4  text-white  sm:text-lg sm:leading-7 font-medium primary px-1 py-2   sm:px-3 sm:py-4  rounded-full  " href={props.guidebook}>
          {' '}
          Download Guidebook
        </a>
      </div>
